"use client";
// src/components/Navbar.tsx — with scroll progress bar + spotlight cursor
    ...
    <>
      ...
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between
          px-[5vw] py-3 border-b border-white/[0.07] transition-all duration-300
          ${scrolled ? "bg-[#030014]/93 backdrop-blur-2xl" : "bg-[#030014]/70 backdrop-blur-xl"}`}
      >
        {/* Logo */}
        <Link href="#hero" className="font-display text-[22px] font-black grad-text leading-none select-none">
          KD.
        </Link>
        ...
        <nav className="flex items-center gap-0.5">
          ...
          <a href="https://github.com/Karandaiya88" target="_blank" rel="noopener noreferrer"
            className="ml-3 px-4 py-1.5 text-[11.5px] font-black tracking-widest uppercase
              ...
              hover:bg-[#00f5ff]/20 hover:shadow-[0_0_22px_rgba(0,245,255,0.22)]
        ...
        {/* Available */}
        <div className="relative flex items-center gap-2 text-[11px] font-bold text-[#34d399] tracking-widest uppercase">
